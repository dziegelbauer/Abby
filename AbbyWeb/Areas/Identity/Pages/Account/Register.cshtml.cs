        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var userRoleName = Request.Form["rdUserRole"].ToString();
                    userRoleName = userRoleName switch
                    {
                        SD.ManagerRole => SD.ManagerRole,
                        SD.KitchenRole => SD.KitchenRole,
                        SD.FrontDeskRole => SD.FrontDeskRole,
                        _ => SD.CustomerRole
                    };
